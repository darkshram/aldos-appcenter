...
public class AppCenter.App : Gtk.Application {
    ...
    public override void activate () {
        ...
        provider.load_from_resource ("org/alcancelibre/appcenter/application.css");
    ...
    public override bool dbus_register (DBusConnection connection, string object_path) throws Error {
        ...
        if (silent) {
            DBusServer.init ();
            try {
                registration_id = connection.register_object ("/org/alcancelibre/appcenter", DBusServer.get_default ());
            } catch (Error e) {
                warning (e.message);
            }

            try {
                search_provider_id = connection.register_object ("/org/alcancelibre/appcenter/SearchProvider", search_provider);
            } catch (Error e) {
                warning (e.message);
            }
        }
